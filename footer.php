...
<footer>
    <div class="footer mt-50 bg-black pl-0 pr-0 footer-bg" style="background: url('<?php bloginfo('stylesheet_directory'); ?>/assets/images/footer.jpg')">
        <div class="footer-layer-1">
            <div class="footer-inner-layer-1">
                <div class="container">
                    <h3 class="footer-h3 roboto-m text-white">Subscribe To Newsletter </h3>
                    <div class="form-group">
                        <input type="text" class="form-control subscribe-input" placeholder="Enter Email">
                        <button type="submit" class="btn submit-button bg-orange roboto-cn-l">Submit</button>
                    </div>
                </div>
            ...
            <div class="footer-menus">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h3 class="f-menu-title mont-b mt-10">Social Links</h3>
            ...
            <div class="copy-right">
                <p class="mont-r text-white text-center">Copyright© yourresumestory.com . All rights reserved</p>
            </div>
        </div>
    </div>
</footer>
